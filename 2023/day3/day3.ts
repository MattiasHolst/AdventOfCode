                            ...
                            if(splittedInput[rowIndex+1]){
                                ...
                                if(!numbersExist){
                                    if(+number && +secondNumber){
                                        ...
                                        const preRowSplit = splittedInput[rowIndex-1].split('');
                                    ...
                                    if(preRowSplit[gearIndex] === '.'){
                                        if((preRowSplit[gearIndex+1] === '0' || +preRowSplit[gearIndex+1])
                                        || (preRowSplit[gearIndex-1] === '0' || +preRowSplit[gearIndex-1])){
